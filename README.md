...
>**EMC** :  electrom microscope control module. Its class __EMC__ class makes it easy to handle simulation control parameters.  
...
```
all of the samples will be copied from __pyemaps__ install directory to a subdirectory named _pyemaps_samples_ in your current working directory.
