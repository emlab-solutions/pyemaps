...
>**DP** :  kinematic diffraction python class. It encapsulates diffraction pattern data generated by __Crystal__ class instance. This python class provides a builtin visualisation of diffraction patterns with Kikuchi and HOLZ lines, and diffracted beams or disks and their Miller indices.   
...
* __si_bloch.py__: demonstrates dynamic diffraction generation with similar control change as.
<!-- 
