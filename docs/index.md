...
5. <a id="contents"></a>[Visualizing pyemaps](#visualizing-pyemaps)
...
## Visualizing pyemaps [`↩`](#contents) <a id="visualizing-pyemaps"></a>
In addition to Python's matplotlib for displaying diffraction patterns generated by __pyemaps__ as shown above, DigitalMicrography (referred as DM here) is another option. The python script support in DM can realize the diffraction patterns from _pyemaps_ with its line and circle annotations as demonstrated below: 
