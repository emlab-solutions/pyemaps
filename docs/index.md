...
>**CSF** :  Crystal structure factors module. This module in __pyemaps__ is design to generate four types of structure factors:
>    * __X-Ray Structure Factors__  (default structure factors in __CSF__ module)
>    * __Electron Structure Factor in kV__ (kilo volts)
>    * __Electron Structure Factor in 1/&#8491;^2__
>    * __Electron Absorption Structure Factor in 1/&#8491;^2__

See sample code below on how to use __Crystal__ class to generate and output these types of structure factors.
...
* NEW
    ...
    * __Crystal Structure Factors (CSF)__. __CSF__ module usage:
    ...
    ```
        generateCSF(...)
        printCSF(...)           <= Display SF data from preview call on standard output 
    ```
