...
def add_mxtal(target):
    ...
    def print_xyz(self, xyzdict):
        ...
        (TODO: A reference to .xyz format)
        
        :param xyzdict: Required. 
        :type xyzdict: dict
    ...
    def write_xyz(self, xyzdict, fn=None):
        '''
        Save mxtal data generated by pyemaps into a .xyz file <fn>
        File path is composed by pyemaps depending on whether 
        PYEMAP_DATA environment variable is set or not.
        (TODO: reference to environment)
        
        The file can be imported into external tool such as Jmole to
        view its content: atomic crystal structure. 
        
    
        .. |mxtal_img| image:: https://github.com/emlab-solutions/imagepypy/raw/main/mxtal02.png
        :alt: Crystal Structure by pyemaps
        :height: 200
        :width: 200
        :target: `mxtal`_ 
        ...
        For an example the crystal structure file imported into Jmole, 
        see: 
    ...
    def generateMxtal(self, 
        ...
        :param trMatrix: Optional. Transformation matrix
        :type trMatrix: array
        :param trShift: Optional. Transformation shift
        :type trShift: array
        :param cellbox: Optional. Locate atoms inside a box defined. 
        :type cellbox: array
        :param xz: Optional.(TODO). 
        :type xz: array
        :param orShift: Optional. Origin shift. 
        :type orShift: float
        :param locASpace: Optional. Locate atoms inside a box defined. 
        :type locASpace: array
        :param bound: Optional. location in A Space. 
        :type bound: 
